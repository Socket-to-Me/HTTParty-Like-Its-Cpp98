...
override FILES_NAME := main log logo socket msg alive terminal numerics server connection channel sockaddr lexer parser cmd cmd_factory invite join kick list mode nick part pass ping privmsg quit topic user pong
