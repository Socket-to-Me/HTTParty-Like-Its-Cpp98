...
override FILES_NAME := main socket msg numerics server channel connection sockaddr lexer parser cmd cmd_factory invite join kick list mode nick part pass ping privmsg quit topic user
