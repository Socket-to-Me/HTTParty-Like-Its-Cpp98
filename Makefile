...
override FILES_NAME := main socket server connection channel sockaddr lexer parser cmd cmd_factory invite join kick list mode nick part pass ping privmsg quit topic user
