...
override FILES_NAME := main socket server channel sockaddr connection lexer parser cmd cmd_factory invite join kick list mode nick part pass ping privmsg quit topic user
